...
local editor_tag = "editor"
local vcs_tag = "vcs"
local net_tag = "net"
local media_tag = "media"
awful.screen.connect_for_each_screen(function(s)
    -- Wallpaper
    set_wallpaper(s)

    -- Each screen has its own tag table.
    awful.tag.add("shell",     {screen = s, layout = awful.layout.suit.fair, selected = true})
    awful.tag.add(browser_tag, {screen = s, layout = awful.layout.suit.tile})
    awful.tag.add(editor_tag,  {screen = s, layout = awful.layout.suit.tile})
...
globalkeys = awful.util.table.join(
    ...
    -- Screenshot
    awful.key({        }, "Print", function () awful.spawn.with_shell("sleep 0.5 && scrot --select") end,
    ...
    awful.key({ }, "XF86AudioLowerVolume", function () awful.spawn("pactl set-sink-mute @DEFAULT_SINK@ false") awful.spawn("pactl set-sink-volume @DEFAULT_SINK@ -5%") end,
        {description = "lower volume", group = "client"}),
    awful.key({ }, "XF86AudioRaiseVolume", function () awful.spawn("pactl set-sink-mute @DEFAULT_SINK@ false") awful.spawn("pactl set-sink-volume @DEFAULT_SINK@ +5%") end,
...
awful.rules.rules = {
    ...
    { rule_any = {
        instance = {
          ...
          "exe", -- Flash in Firefox
          "Luakit", -- Flash in Chromium
          "plugin-container", -- Flash in Firefox
        },
        class = {
          "Arandr",
          "Gpick",
    ...
    { rule_any = { class = { "Digikam", "digikam", "Gimp", "Hugin", "Inkscape", "jetbrains-clion", "jetbrains-idea", "jetbrains-idea-ce", "keepassxc", "libreoffice-startcenter", "Openscad", "Simple-scan", "Sqliteman" } },
      properties = { screen = 1, tag = editor_tag } },
