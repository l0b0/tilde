...
sudo pacman --sync alsa-plugins awesome ekiga evince file-roller firefox git gnome-icon-theme gnome-keyring gparted hunspell-de hunspell-en hunspell-fr jedit keepassx lsof meld ntp pidgin scrot thunar thunar-archive-plugin thunar-volman tk vim vlc xorg-server xorg-server-common xorg-xinit xorg-xrandr xorg-xrdb xournal xscreensaver xterm # desktop 
