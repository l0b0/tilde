...
sudo pacman --sync alsa-plugins awesome ekiga firefox git gnome-icon-theme gnome-keyring hunspell-de hunspell-en hunspell-fr jedit keepassx lsof meld ntp pidgin scrot thunar tk vim vlc xorg-server xorg-server-common xorg-xinit xorg-xrandr xorg-xrdb xscreensaver xterm # desktop 
