...
sudo pacman --sync --needed --refresh abcde acpid android-tools base-devel darktable dkms dnsutils dos2unix dosfstools esmtp evince exfat-utils file-roller fortune-mod fuse-exfat gnome-icon-theme gnome-keyring gparted gphoto2 gsmartcontrol gst-libav gst-plugins-good gutenprint gvfs gvfs-gphoto2 htop ipython iw kdemultimedia-mplayerthumbs lib32-alsa-plugins lib32-libpulse libreoffice-still-calc libreoffice-still-draw libreoffice-still-en-GB libreoffice-still-impress libreoffice-still-math libreoffice-still-writer linux-headers livestreamer lsb-release lsof markdown mcomix meld mlocate mutt net-tools network-manager-applet networkmanager ntfs-3g offlineimap openssh pavucontrol pkgbuild-introspection polkit-gnome powertop pulseaudio-alsa puppet pychecker python-pip python2-pip redshift rsync ruby-ronn ruby-shadow sqliteman sshfs strace system-config-printer tcpdump thunar thunar-archive-plugin thunar-volman tigervnc tk vagrant vim virtualbox virtualbox-guest-utils virtualbox-host-dkms whois wireshark-gtk xautolock xorg-server xorg-server-common xorg-xev xorg-xinit xorg-xinput xorg-xkill xorg-xmodmap xorg-xprop xorg-xrandr xorg-xrdb xorg-xwininfo # software packages install 
