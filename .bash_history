...
sudo pacman --sync --needed alsa-plugins alsa-utils aspell-de aspell-en aspell-fr awesome base-devel bash-completion bc digikam ekiga esmtp evince file-roller firefox flashplugin git gnome-icon-theme gnome-keyring gparted hunspell-de hunspell-en hunspell-fr inkscape iw jedit keepassx libreoffice-calc libreoffice-draw libreoffice-impress libreoffice-math libreoffice-writer lsof meld mutt net-tools network-manager-applet networkmanager ntfs-3g ntp offlineimap openssh pidgin powertop pychecker python-pip scrot slim steam thunar thunar-archive-plugin thunar-volman tigervnc tk ttf-bitstream-vera ttf-dejavu vim vlc whois wireshark-gtk xorg-server xorg-server-common xorg-xinit xorg-xrandr xorg-xrdb xournal xscreensaver xterm # desktop 
