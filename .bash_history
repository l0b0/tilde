...
sudo pacman --sync --needed --refresh abcde acpid android-tools aspell-de aspell-en aspell-fr awesome base-devel bash-completion bc cups cups-filters darktable deluge dia digikam dkms dnsutils dos2unix dosfstools eog esmtp evince exfat-utils feh file-roller flashplugin fortune-mod fuse-exfat gimp git gnome-icon-theme gnome-keyring gparted gphoto2 graphviz gsmartcontrol gst-libav gst-plugins-good gutenprint gvfs gvfs-gphoto2 htop hugin hunspell-de hunspell-en hunspell-fr inkscape ipython iw kdemultimedia-mplayerthumbs lib32-alsa-plugins lib32-libpulse libreoffice-still-calc libreoffice-still-draw libreoffice-still-en-GB libreoffice-still-impress libreoffice-still-math libreoffice-still-writer linux-headers livestreamer lsb-release lsof markdown mcomix meld mlocate mutt net-tools network-manager-applet networkmanager ntfs-3g offlineimap openscad openssh pavucontrol pkgbuild-introspection polkit-gnome powertop pulseaudio-alsa puppet pychecker python-pip python2-pip qcad redshift rsync ruby-ronn ruby-shadow scrot simple-scan slim slock sqliteman sshfs strace system-config-printer tcpdump thunar thunar-archive-plugin thunar-volman tigervnc tk vagrant vim virtualbox virtualbox-guest-utils virtualbox-host-dkms vlc whois wireshark-gtk xautolock xorg-server xorg-server-common xorg-xev xorg-xinit xorg-xinput xorg-xkill xorg-xmodmap xorg-xprop xorg-xrandr xorg-xrdb xorg-xwininfo xournal xterm youtube-dl # software packages install 
