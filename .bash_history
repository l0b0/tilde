...
sudo pacman --sync alsa-plugins aspell-de aspell-en aspell-fr awesome bc ekiga esmpt evince file-roller firefox git gnome-icon-theme gnome-keyring gparted hunspell-de hunspell-en hunspell-fr jedit keepassx lsof make meld mutt ntfs-3g ntp offlineimap pidgin scrot slim thunar thunar-archive-plugin thunar-volman tigervnc tk ttf-bitstream-vera ttf-dejavu vim vlc xorg-server xorg-server-common xorg-xinit xorg-xrandr xorg-xrdb xournal xscreensaver xterm # desktop 
