...
sudo pacman --sync alsa-plugins aspell-de aspell-en aspell-fr awesome bc ekiga evince file-roller firefox git gnome-icon-theme gnome-keyring gparted hunspell-de hunspell-en hunspell-fr jedit keepassx lsof make meld ntfs-3g ntp pidgin scrot slim thunar thunar-archive-plugin thunar-volman tk vim vlc xorg-server xorg-server-common xorg-xinit xorg-xrandr xorg-xrdb xournal xscreensaver xterm # desktop 
